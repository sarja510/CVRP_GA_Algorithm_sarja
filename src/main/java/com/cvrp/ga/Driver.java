...
public class Driver {
    ...
    public ArrayList<City> initialRoute = new ArrayList<City>(Arrays.asList(
            ...
            new City("Boston", 42.3601, -71.0589,1),
            new City("Houston", 29.7604, -95.3698,2),
            new City("Austin", 30.2672, -97.7431,3),
            new City("San Francisco", 37.7749, -122.4194,4),
            new City("Denver", 39.7392, -104.9903,5),
            new City("Los Angeles", 34.0522, -118.2437,6),
            new City("Chicago", 41.8781, -87.6298,7),
            new City("New York", 40.7128, -74.0059,8),
            new City("Dallas", 32.7767, -96.7970,9),
            new City("Seattle", 47.6062, -122.3321,10)
